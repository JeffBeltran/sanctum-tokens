                ...
                <div>
                    <div class="action">
                        <div class="border-b border-40">
                            ...
                            <div class="flex w-full">
                                <div class="w-1/5 px-8 py-6">
                                    <label for="scopes" class="inline-block text-80 pt-2 leading-tight">Abilities</label>
                                </div>
                                <div class="py-6 px-8 w-1/2">
                                    <slot name="abilities"></slot>

                                    <div class="help-text help-text mt-2">Comma seperated list of abilities to apply to token</div>
                                </div>
                            </div>
                        </div>
                    </div>
